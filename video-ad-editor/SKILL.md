...
```
**شارة الحساب مطفية افتراضياً** (`badgeUntil: 0`) — أغلب المستخدمين ما يبونها، والاسم يبقى بكرت النهاية فقط. `badgeUntil: 3` تعيدها أول ٣ ثوانٍ، و`badge:false` مدعومة للتوافق. كل الرسم يشتق ألوانه من هذي القيم أوتوماتيكياً — الكروت والظلال ولون النص فوق أزرار التمييز (يُحسب من إضاءة اللون). خلفية غامقة أو فاتحة، الاثنتان تشتغلان.
...
```
**القفزة على التايم-لاين تبقي التشغيل شغّالاً وتكمّل من مكانها** (v3.1 — بلاغ المستخدم 23 سبتمبر:
كان السحب أثناء التشغيل يرجّع المقطع لمكان بدء التشغيل فيُضطر يشوفه من أوله).
فحص المنطق: `node scripts/studio.test.mjs`.
